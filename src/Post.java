...
public class Post implements PostInterface, Serializable {
    ...
    // constructors
    public Post(User user, String title, String imageURL, String description, String date) throws DateFormatException {
    ...
    public Post(User user, String title, String description, String date) throws DateFormatException {
        this.user = user;
        this.title = title;
        this.image = false;
        this.description = description;
