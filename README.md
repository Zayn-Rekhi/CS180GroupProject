...
6. Ensures functionality of modifying a user by replacing it with new User object with new information
7. Ensures functionality of removing user
8. Ensures functionality of writing users to text file and then reading from it to ensure persistency
...
8. Ensures functionality of retrieving a feed of a friend's posts
